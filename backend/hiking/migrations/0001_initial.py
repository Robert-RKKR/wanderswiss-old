    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regions', models.ManyToManyField(help_text='Region(s) through which the route passes.', limit_choices_to={'type': 6}, related_name='route_regions', to='infopedia.choicemodel', verbose_name='Regions')),
