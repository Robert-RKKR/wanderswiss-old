    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.BooleanField(default=True, verbose_name='Published')),
                ('published', models.DateTimeField(blank=True, null=True, verbose_name='Publish Down')),
                ('access', models.IntegerField(default=1, verbose_name='Access Level')),
