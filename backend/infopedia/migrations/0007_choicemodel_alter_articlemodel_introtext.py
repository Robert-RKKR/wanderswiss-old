...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('infopedia', '0006_articlemodel_introtext'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, 'Region'), (2, 'Point of Interest')], default=2, help_text='Xxx.', verbose_name='Choice type')),
            ],
            options={
                'verbose_name': 'Choice',
        ...
        migrations.AlterField(
            ...
            name='introtext',
            field=models.TextField(blank=True, help_text='Xxx.', null=True, verbose_name='Intro'),
        ),
    ]
