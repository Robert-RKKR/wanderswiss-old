# Generated by Django 5.0.8 on 2024-08-15 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='The unique name of the administrator used for login and identification.', max_length=64, unique=True, verbose_name='Username')),
                ('name', models.CharField(help_text='Xxx.', max_length=64, unique=True, verbose_name='First name')),
                ('surname', models.CharField(help_text='Xxx.', max_length=64, unique=True, verbose_name='Surname')),
