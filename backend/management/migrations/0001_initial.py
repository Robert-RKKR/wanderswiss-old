    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Administrator'), (2, 'Author'), (3, 'Guest')], default=3, help_text='User role.', verbose_name='Role')),
                ('username', models.CharField(help_text='The unique name of the administrator used for login and identification.', max_length=128, unique=True, verbose_name='Username')),
                ('first_name', models.CharField(help_text='User first name.', max_length=128, unique=True, verbose_name='First name')),
                ('last_name', models.CharField(help_text='User last name.', max_length=128, unique=True, verbose_name='Last name')),
