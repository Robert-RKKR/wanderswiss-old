    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countrys', models.ManyToManyField(help_text='Country(s) through which the route passes.', limit_choices_to={'type': 5}, related_name='card_countrys', to='infopedia.choicemodel', verbose_name='Countrys')),
                ...
                ('regions', models.ManyToManyField(help_text='Region(s) through which the route passes.', limit_choices_to={'type': 6}, related_name='card_regions', to='infopedia.choicemodel', verbose_name='Regions')),
